import postBgImg from "@/assets/images/post-bg.jpg";
import postSampleImg from "@/assets/images/post-sample-image.jpg";
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
              <p>
                ...
                as equals. The airman&apos;s earth, if free men make it, will be truly round: a globe in practice, not
                in theory.
              </p>
